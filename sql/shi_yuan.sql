...
CREATE TABLE `b_artificer_info`  (
  ...
  `is_leave` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '是否请假',
...
-- ----------------------------
INSERT INTO `b_artificer_info` VALUES (4, 101, '典唐按摩', '1 号张三', '1 号张三', '0', '18888888888', '0', 1.00, '2022-09-01 00:00:00', '反对犯得上大师傅大师傅撒打发撒打发撒打发撒打发撒打发撒打发sd', 'Y', 3, 0, '1', 'f撒打发稍等撒打发撒打发', 'admin', '2022-09-02 12:23:16', NULL, NULL);
INSERT INTO `b_artificer_info` VALUES (5, 200, '典唐按摩', '1 李四', '李四', '0', '15555555555', '0', 233.00, '2022-09-03 00:00:00', '容易引发', 'Y', 2, 0, '1', 'i给i不可能空间', 'admin', '2022-09-03 17:35:45', NULL, NULL);
INSERT INTO `b_artificer_info` VALUES (6, 100, '典唐按摩', '1号田师傅', '田师傅', '1', '15891727073', '0', NULL, '2022-09-06 00:00:00', NULL, 'Y', 1, 0, '1', NULL, 'admin', '2022-09-06 17:18:31', NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '业务表--会员信息' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '业务表---订单和辅助项目关联表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `b_order_info` VALUES (21, '2023-02-11 00:06:00', '2023-02-12 00:56:00', 188.00, '2', '2', '1', 2, '98全是推拿调理', 4, '1 号张三', NULL, NULL, '2023-02-12 00:56:00', '2023-03-18 00:06:12', '典唐', '2023-02-12 00:57:08', '典唐', NULL);
INSERT INTO `b_order_info` VALUES (24, '2023-02-11 23:50:00', '2023-02-11 23:50:00', 158.00, '2', '2', '1', 2, '98全是推拿调理', 5, '1 李四', NULL, NULL, '2023-02-11 23:50:00', '2023-03-18 00:06:12', '典唐', '2023-02-11 23:50:25', '典唐', NULL);
INSERT INTO `b_order_info` VALUES (25, '2023-02-12 17:16:00', '2023-02-12 21:47:00', 98.00, '2', '2', '1', 2, '98全是推拿调理', 4, '1 号张三', NULL, NULL, '2023-02-12 21:47:00', '2023-03-18 00:06:12', '典唐', '2023-02-12 21:47:18', '典唐', NULL);
INSERT INTO `b_order_info` VALUES (29, '2023-02-15 00:00:00', '2023-02-22 23:28:00', 98.00, '2', '2', '1', 2, '98全是推拿调理', 5, '1 李四', '赵四232', 0, '2023-02-22 23:28:00', '2023-03-18 00:06:12', '典唐', '2023-02-22 23:28:30', '典唐', '而为人温柔违法的事是都调试');
INSERT INTO `b_order_info` VALUES (32, '2023-02-15 00:02:00', '2023-02-15 01:02:00', 98.00, '0', NULL, '1', 2, '98全是推拿调理', 6, '1号田师傅', '闫凯2', 0, NULL, '2023-03-18 00:06:12', '典唐', NULL, NULL, NULL);
INSERT INTO `b_order_info` VALUES (33, '2023-02-20 22:36:00', '2023-02-21 00:23:00', 159.00, '2', '1', '1', 11, '99主服务项目', 4, '1 号张三', NULL, 8, '2023-02-21 00:23:00', '2023-03-18 00:06:12', '典唐', '2023-02-21 00:23:25', '典唐', NULL);
INSERT INTO `b_order_info` VALUES (34, '2023-02-20 22:48:00', '2023-02-21 00:16:00', 159.00, '2', '2', '1', 11, '99主服务项目', 6, '1号田师傅', NULL, NULL, '2023-02-21 00:16:00', '2023-03-18 00:06:12', '典唐', '2023-02-21 00:16:41', '典唐', NULL);
...
-- ----------------------------
INSERT INTO `gen_table_column` VALUES (1, '1', 'artificer_id', '主键id', 'bigint', 'Long', 'artificerId', '1', '1', NULL, '1', NULL, NULL, NULL, 'EQ', 'input', NULL, 1, 'admin', '2022-09-01 23:47:06', NULL, '2023-03-18 19:59:56');
INSERT INTO `gen_table_column` VALUES (2, '1', 'dept_id', '所属店铺id', 'bigint', 'Long', 'deptId', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 2, 'admin', '2022-09-01 23:47:06', NULL, '2023-03-18 19:59:56');
INSERT INTO `gen_table_column` VALUES (3, '1', 'artificer_full_name', '技师名称', 'varchar(255)', 'String', 'artificerFullName', '0', '0', NULL, '1', '1', '1', '1', 'LIKE', 'input', '', 4, 'admin', '2022-09-01 23:47:06', NULL, '2023-03-18 19:59:56');
INSERT INTO `gen_table_column` VALUES (4, '1', 'artificer_name', '技师简称', 'varchar(255)', 'String', 'artificerName', '0', '0', NULL, '1', '1', '1', '1', 'LIKE', 'input', '', 5, 'admin', '2022-09-01 23:47:06', NULL, '2023-03-18 19:59:56');
INSERT INTO `gen_table_column` VALUES (5, '1', 'artificer_level', '技师等级关联字典表类型b_artificer_level', 'char(5)', 'String', 'artificerLevel', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 6, 'admin', '2022-09-01 23:47:06', NULL, '2023-03-18 19:59:56');
INSERT INTO `gen_table_column` VALUES (6, '1', 'phone_number', '手机号', 'varchar(11)', 'String', 'phoneNumber', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 7, 'admin', '2022-09-01 23:47:06', NULL, '2023-03-18 19:59:56');
INSERT INTO `gen_table_column` VALUES (7, '1', 'sex', '性别关联字典表（0男 1女 2未知）', 'char(1)', 'String', 'sex', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'select', '', 8, 'admin', '2022-09-01 23:47:06', NULL, '2023-03-18 19:59:56');
INSERT INTO `gen_table_column` VALUES (8, '1', 'salary', '薪资', 'decimal(10,2)', 'BigDecimal', 'salary', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 9, 'admin', '2022-09-01 23:47:06', NULL, '2023-03-18 19:59:56');
INSERT INTO `gen_table_column` VALUES (9, '1', 'entry_time', '入职时间', 'datetime', 'Date', 'entryTime', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'datetime', '', 10, 'admin', '2022-09-01 23:47:06', NULL, '2023-03-18 19:59:56');
INSERT INTO `gen_table_column` VALUES (10, '1', 'speciality', '特长', 'varchar(255)', 'String', 'speciality', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 11, 'admin', '2022-09-01 23:47:06', NULL, '2023-03-18 19:59:56');
INSERT INTO `gen_table_column` VALUES (11, '1', 'is_bell', '是否排钟（0：否；1：是）', 'char(1)', 'String', 'isBell', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 12, 'admin', '2022-09-01 23:47:06', NULL, '2023-03-18 19:59:56');
INSERT INTO `gen_table_column` VALUES (12, '1', 'remark', '备注', 'varchar(255)', 'String', 'remark', '0', '0', NULL, '1', '1', '1', NULL, 'EQ', 'input', '', 16, 'admin', '2022-09-01 23:47:06', NULL, '2023-03-18 19:59:56');
INSERT INTO `gen_table_column` VALUES (13, '1', 'create_name', '创建人', 'varchar(255)', 'String', 'createName', '0', '0', NULL, '1', '1', '1', '1', 'LIKE', 'input', '', 17, 'admin', '2022-09-01 23:47:06', NULL, '2023-03-18 19:59:56');
INSERT INTO `gen_table_column` VALUES (14, '1', 'create_time', '创建时间', 'datetime', 'Date', 'createTime', '0', '0', NULL, '1', NULL, NULL, NULL, 'EQ', 'datetime', NULL, 18, 'admin', '2022-09-01 23:47:06', NULL, '2023-03-18 19:59:56');
INSERT INTO `gen_table_column` VALUES (15, '1', 'modify_name', '修改人', 'varchar(255)', 'String', 'modifyName', '0', '0', NULL, '1', '1', '1', '1', 'LIKE', 'input', '', 19, 'admin', '2022-09-01 23:47:06', NULL, '2023-03-18 19:59:56');
INSERT INTO `gen_table_column` VALUES (16, '1', 'modify_time', '修改时间', 'datetime', 'Date', 'modifyTime', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'datetime', '', 20, 'admin', '2022-09-01 23:47:06', NULL, '2023-03-18 19:59:56');
INSERT INTO `gen_table_column` VALUES (17, '1', 'dept_name', '所属门店名称', 'varchar(255)', 'String', 'deptName', '0', '0', NULL, '1', '1', '1', '1', 'LIKE', 'input', '', 3, '', '2022-09-02 11:12:54', NULL, '2023-03-18 19:59:56');
...
INSERT INTO `gen_table_column` VALUES (92, '1', 'order_num', '排序', 'int', 'Long', 'orderNum', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 13, '', '2023-03-18 19:59:56', '', NULL);
INSERT INTO `gen_table_column` VALUES (93, '1', 'bell_num', '当日排钟次数', 'int', 'Long', 'bellNum', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 14, '', '2023-03-18 19:59:56', '', NULL);
INSERT INTO `gen_table_column` VALUES (94, '1', 'is_leave', '是否请假', 'char(1)', 'String', 'isLeave', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 15, '', '2023-03-18 19:59:56', '', NULL);
...
-- ----------------------------
INSERT INTO `sys_logininfor` VALUES (1, 'admin', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '登录成功', '2023-03-20 08:38:13');
...
-- ----------------------------
INSERT INTO `sys_oper_log` VALUES (1, '操作日志', 9, 'com.yk.web.controller.monitor.SysOperlogController.clean()', 'DELETE', 1, 'admin', NULL, '/monitor/operlog/clean', '127.0.0.1', '内网IP', '{}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2023-03-20 09:02:40');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 100, 'admin', '典唐', '00', 'yanakai@126.com', '18888888888', '1', '/profile/avatar/2022/09/03/blob_20220903120800A002.jpeg', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2023-03-20 08:38:13', 'admin', '2022-09-01 23:37:14', '', '2023-03-20 08:38:13', '管理员');
