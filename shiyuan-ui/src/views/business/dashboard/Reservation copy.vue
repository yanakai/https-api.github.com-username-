        ...
        <el-form ref="jieZhangForm" :model="jieZhangForm" :rules="jieZhangRules" label-width="90px">
            ...
            <el-col :span="24">
                ...
                <el-autocomplete style="width:100%"
                    v-model="memberName"
                    :fetch-suggestions="memberSearchAsync"
                    @select="handleMemberJieZhangSelect"
                    placeholder="请输入会员姓名、手机号"
...
<script>
import { orderDataList, getOrder, delOrder, addOrder, updateOrder, savePaymentData } from "@/api/business/order";
...
export default {
  ...
  methods: {
    ...
    // 会员信息选中赋值
    handleMemberJieZhangSelect(item){
      // 会员信息回显
      this.memberInfoDataView = true;
      // 选中会员密码赋值
